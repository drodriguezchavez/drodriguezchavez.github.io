...
As we can see, $\alpha$ and $\beta$ are a trade-off with each other. As $\alpha$ increases, $\beta$ decreases. See what happens with a decreased, or more strict, $\alpha$ of 0.01.
