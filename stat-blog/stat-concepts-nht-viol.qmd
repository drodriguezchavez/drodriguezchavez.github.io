...
A type-II error is when one incorrectly fails to reject the null even though the null hypothesis is false. A common analogy for a type-II error is when a court fails to convict a guilty person. The type-II error conditions on the null hypothesis being false. The probability of a type-II error is usually denoted as $\beta$. The usual threshold for this is 0.20. We see $\beta$ in blue below. 
