...
So now we have the solution to the least squares equations. We have a vector of $\hat{\beta}$'s, as well as an estimate for $s^2$. Now we need to which in turn gives us the standard error for the $\hat{\beta}$'s. How can we get this?
