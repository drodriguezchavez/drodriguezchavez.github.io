...
### Calculating our test statistic and evaluating our hypothesis test 
...
**How do we evaluate this test statistic?** 
We know that it comes from a t-distribution and we want evaluate the probability that we would get a value as extreme or more. 
...
```{r}
plot(seq(-3, 3, 0.01), dnorm(seq(-3, 3, 0.01), 0, 1), pch = 20)
# points(rnorm(50, 0, 1), 0, col = 'red')
